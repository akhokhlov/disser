...
работе~\citesubmitted{Khokhlova&Kipnis&Malygina_2011}.
...
% ----------------------------------------------------------------
\renewcommand\bibsection{\nsection{Список вак публикаций}}

% Префикс номеров ссылок на работы соискателя
\def\BibPrefix{A}
\bibliographystylesubmitted{gost705s}
\bibliographysubmitted{thesis}
