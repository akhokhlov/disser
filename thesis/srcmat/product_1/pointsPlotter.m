%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Строит точки с конусом.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [result, intervalsCell] = ...
pointsPlotter(lambda,mu,maxdistanse,resolution)
addPath('../common');
...
if exist('resolution', 'var') == false 
	...
	dist_real = distance(m, la, max_tau, ...
		max_tau-max_tau/10) ;
