\begin{verbatim}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Ќаходит точку границы области устойчивости на луче, определЄнном углом
% phi в пол€рной системе координат с заданной точностью epsilon.
% ¬озвращает координату точки на заданном луче с точностью epsilon.
