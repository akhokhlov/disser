...
На рис.~\ref{fig:domain_no_delayright},~\ref{fig:domain_yes_delayright} 
показаны области $D_{\tau}$ в плоскости параметров $(a, b)$ модели нейронной сети для некоторых
...
рис.~\ref{fig:domain_no_delayright}, то система~\eqref{matrixP},
\eqref{mainmatrix1} неустойчива при достаточно больших $n$. Аналогичные
утверждения верны для рис.~\ref{fig:domain_yes_delayright} и системы
...
\begin{figure}[ht]
    ...
    \caption{
        ...
        с неограниченным числом нейронов
        }
