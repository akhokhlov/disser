...
\begin{figure}[ht]
    ...
    \caption{
        Области устойчивости  для системы~\eqref{matrixP},~\eqref{mainmatrix1} с неограниченным числом нейронов.
        }
...
\begin{figure}[ht]
    ...
    \caption{
        Области устойчивости  для системы~\eqref{matrixP},~\eqref{mainmatrix2} с неограниченным числом нейронов.
        }
