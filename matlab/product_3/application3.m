...
% Для её работы требуются следующие функции: plotterBoundness, 
% searchPointInRowGeom, solverBoundnessSmart, straightStabAnalizer, а также 
% некоторые общие функции (arg, coalition, cone, getIntervals, intersection, 
